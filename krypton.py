...
if __name__ == '__main__':
    ...
    f_train_path = "/data/users/c3471tl/tc204_20210621_lstm/dataset/tc204/train/"
    ...
    f_test_path = "/data/users/c3471tl/tc204_20210621_lstm/dataset/tc204/test/"
    ...
    # create model
    f_save_path = "/data/users/c3471tl/tc204_20210621_lstm/"
    for count in range(10):
        model = Sequential()
        model.add(LSTM(40, input_shape=(num_timesteps, num_features)))
        ...
        # plt.show()
        joblib.dump(cdf_x, f_save_path + "cdf_x_lstm.save")
        joblib.dump(cdf_y, f_save_path + "cdf_y_lstm.save")
